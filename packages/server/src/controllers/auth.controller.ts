...
export const basicLogin = async (req: Request, res: Response) => {
    ...
    appLoggerService.verbose(
        `request ${req.id} finished basic login, got response from auth server: ${authRes}`
    );
    res.send(authRes);
};
export const basicSignup = async (req: Request, res: Response) => {
    ...
    appLoggerService.verbose(
        `request ${req.id} finished basic signup, got response from auth server: ${authRes}`
    );
    res.send(authRes);
};
export const basicReqReset = async (req: Request, res: Response) => {
    ...
    appLoggerService.verbose(
        `request ${req.id} finished basic reset request, got response from auth server: ${authRes}`
    );
    res.send(authRes);
};
export const basicReset = async (req: Request, res: Response) => {
    ...
    appLoggerService.verbose(
        `request ${req.id} finished basic reset, got response from auth server: ${authRes}`
    );
    res.send(authRes);
};
...
export const googleLogin = async (req: Request, res: Response) => {
    ...
    appLoggerService.verbose(
        `request ${req.id} finished google login, got response from auth server: ${authRes}`
    );
    res.send(authRes);
};
export const facebookLogin = async (req: Request, res: Response) => {
    ...
    appLoggerService.verbose(
        `request ${req.id} finished facebook login, got response from auth server: ${authRes}`
    );
    res.send(authRes);
};
