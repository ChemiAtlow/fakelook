...
export const basicSignup = async (req: Request, res: Response) => {
    ...
    const { data } = await authServer.post("/basic/signup", req);
    appLoggerService.verbose(
...
export const basicReqReset = async (req: Request, res: Response) => {
    ...
    const { data } = await authServer.post("/basic/reset", req);
    appLoggerService.verbose(
...
export const basicReset = async (req: Request, res: Response) => {
    ...
    const { data } = await authServer.post("/basic/reset/:token", req);
    appLoggerService.verbose(
...
export const googleLogin = async (req: Request, res: Response) => {
    ...
    const { data } = await authServer.post("/google/login", req);
    appLoggerService.verbose(
...
export const facebookLogin = async (req: Request, res: Response) => {
    ...
    const { data } = await authServer.post("/facebook/login", req);
    appLoggerService.verbose(
